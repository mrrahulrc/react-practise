...
const Body = () => {
  ...
  const fetchData = async () => {
    let data = await fetch("https://raw.githubusercontent.com/namastedev/namaste-react/refs/heads/main/swiggy-api")
  ...
  return restaurantList.length === 0 ? <ShimmerLoader /> : (
    <div className="body">
        ...
        <div className="search">
          ...
          <button 
            ...
            onClick={() => {
              ...
              const filteredList = restaurantList.filter(ele => ele.info.name.toLowerCase().includes(searchValue.toLowerCase()))
